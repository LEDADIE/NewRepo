...
namespace BulkyBookWeb.Controllers
{
    public class CategoriesTempController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,CreatedDateTime,Displayorder,Name")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryId,CreatedDateTime,Displayorder,Name")] Category category)
        {
